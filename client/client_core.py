...
class SendNormalMsg(object):
    ...
    def __init__(self, msg, quit_msg):
        self.connection = pika.BlockingConnection(pika.ConnectionParameters(host=settings.MQServer))
        self.msg = copy.deepcopy(msg)
...
def main():
    ...
    connection = pika.BlockingConnection(pika.ConnectionParameters(host=settings.MQServer))
